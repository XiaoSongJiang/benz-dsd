...
class ThinkOauthInfo{
    ...
    //登录成功，获取腾讯微博用户信息
    public static function tencent($token){
        //import("ORG.ThinkSDK.ThinkOauth");
    ...
    //登录成功，获取人人网用户信息
    public static function renren($token){
    ...
    //登录成功，获取Google用户信息
    public static function msn($token){
    ...
    //登录成功，获取点点用户信息
    public static function diandian($token){
    ...
    //登录成功，获取开心网用户信息
    public static function kaixin($token){
    ...
    //登录成功，获取搜狐用户信息
    public static function sohu($token){
